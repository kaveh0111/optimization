...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%  N'oubliez-pas de changer l'option <<Mise à l'échelle>> dans les options d'impression 
%% pour la valeur <<Aucune>> pour que les marges soient imprimés correctement.
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%% Il est possible de rajouter la concentration avec l'intitulé du diplôme en définissant la variable \concentration:
%\newcommand{\concentration}{génie logiciel}

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% MODIFICATION DE LA PAGE TITRE POUR UNE COTUTELLE
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%% Il est possible de rajouter l'école avec laquelle la thèse a été réalisée en co-tutelle  en utilisant la commande \cotutelle:
\cotutelle{ECOLE NATIONALE DE XXXX}
...
\begin{figure}
	...
	\fbox{ % Les figures doivent être délimitées par un rectangle
	 ...
	 \\ \parbox{0.7\textwidth}{\caption[Courte légende pour la liste des figures]{Test de longue légende, avec utilisation de framebox et parbox pour restreindre la largeur de la légende}\label{fig:vueEts}} % Utilisation d'une parbox pour restreindre la largeur de la légende. Ici la taille maximale a été fixée à 5% de moins que la figure (0.7\textwidth). Le décanat demande d'éviter d'avoir des légendes qui dépasse les figures, dans la mesure du possible (si l'image est trop petite, la légende peut dépasser sa largeur).
\end{figure}
...
\TitleOfAlgo{Exemple d'algorithme}
...
Citation d'une référence de la liste de référence "refs" déclarée au début du document \citeprefs{Test}.
...
%%- Bibliographie -%%
\cleardoublepage
%Interligne simple pour la bibliographie
\begin{spacing}{1}
	...
	\phantomsection % Ajout d'une ancre pour hyperref
